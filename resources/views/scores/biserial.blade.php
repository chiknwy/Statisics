...
<body class=" bg-gray-900 text-blue-400  "> 
        ...
        <nav class="container mx-auto flex items-center justify-between opacity-100">
            <div class="text-blue-400 items-center space-x-4 ">
                ...
                <div id="menu" class="hidden absolute left-0 mt-2 py-2 bg-gray-700 rounded-lg shadow-lg">
                    ...
                    <a href="#" class="block px-4 py-2 text-blue-400 hover:text-blue-300">Biserial</a>
                </div>
            </div>
    ...
    <h1 class="font-bold text-2xl py-8 px-8">Table Korelasi Point Bi Serial</h1>
    ...
    <div class="container py-2 px-8">
        <div class="container mx-auto width-3/5 px-12 mt-4 bg-gray-900 py-6 rounded-md">
            <table id="myTables" class="table-auto pb-2 w-full bg-gray-800 shadow-lg rounded-lg border border-gray-300 text-blue-500">
                <thead>
                    <tr>
                        <th class="border border-black px-4 py-2" colspan="4">Data summary</th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    <tr>
                        <td class="border border-black px-4 py-2">N</td>
                        <td class="border border-black px-4 py-2">{{ $N }}</td>
                        <td class="border border-black px-4 py-2">{{ $N }}</td>
                        <td class="border border-black px-4 py-2">{{ $Ntotal }}</td>
                    </tr>
                    <tr>
                        <td class="border border-black px-4 py-2">ΣY</td>
                        <td class="border border-black px-4 py-2">{{ $sumX1 }}</td>
                        <td class="border border-black px-4 py-2">{{ $sumX2 }}</td>
                        <td class="border border-black px-4 py-2">{{ $sumN }}</td>

                    </tr>
                    <tr>
                        <td class="border border-black px-4 py-2">ΣY2</td>
                        <td class="border border-black px-4 py-2">{{ $sumY2X1 }}</td>
                        <td class="border border-black px-4 py-2">{{ $sumY2X2 }}</td>
                        <td class="border border-black px-4 py-2">{{ $sumY2N }}</td>
                    </tr>
                    <tr>
                        <td class="border border-black px-4 py-2">SSY</td>
                        <td class="border border-black px-4 py-2">{{ $SSYX1 }}</td>
                        <td class="border border-black px-4 py-2">{{ $SSYX2 }}</td>
                        <td class="border border-black px-4 py-2">{{ $SSYN }}</td>
                    </tr>
                    <tr>
                        <td class="border border-black px-4 py-2">Mean Y</td>
                        <td class="border border-black px-4 py-2">{{ $meanX1 }}</td>
                        <td class="border border-black px-4 py-2">{{ $meanX2 }}</td>
                        <td class="border border-black px-4 py-2">{{ $meanN }}</td>
                    </tr>
