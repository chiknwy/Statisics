...
<body class=" bg-gray-900 text-blue-400  "> 
        ...
        <nav class="container mx-auto flex items-center justify-between opacity-100">
            <div class="text-blue-400 items-center space-x-4 ">
                ...
                <div id="menu" class="hidden absolute left-0 mt-2 py-2 bg-gray-700 rounded-lg shadow-lg">
                    <a href="#" class="block px-4 py-2 text-blue-400 hover:text-blue-300">Data Tunggal</a>
    ...
    <h1 class="font-bold text-2xl py-8 px-8">Table Data Tunggal</h1>
                ...
                <tbody>
                    ...
                    @foreach ($scores as $score)
                        <tr>
                            ...
                            <td class="border border-black px-4 py-2">{{ $score->score }}</td>
                            <td class="border border-black px-4 py-2">
                                <a href="/scores/update/{{$score->id}}" class=""> <button class="bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-2 rounded">update</button></a>
                                
                                <form action="/scores/delete/{{ $score->id }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <br>
                                    <button type="submit" class="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-2 rounded">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @php
