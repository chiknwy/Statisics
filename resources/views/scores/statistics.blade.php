...
<body class="bg-gray-900 text-blue-400 border border-black">
        ...
        <nav class="container mx-auto flex items-center justify-between opacity-100">
            <div class="text-blue-400 items-center space-x-4 ">
                ...
                <div id="menu" class="hidden absolute left-0 mt-2 py-2 bg-gray-700 rounded-lg shadow-lg">
                    ...
                    <a href="#" class="block px-4 py-2 text-blue-400 hover:text-blue-300">Table Deskripsi Data</a>
    ...
    <h1 class="font-bold text-2xl py-8 px-8"> Deskripsi Data</h1>
   ...
   <table class="table-auto pb-2 w-full bg-gray-800 shadow-lg rounded-lg border border-black text-blue-500">
    <tr>
        <th class="border border-black px-4 py-2">Min</th>
        <th class="border border-black px-4 py-2">Max</th>
        <th class="border border-black px-4 py-2">Average</th>
        <th class="border border-black px-4 py-2">Total</th>
        <th class="border border-black px-4 py-2">Standard Deviation</th>
    </tr>
    <tr>
        <th class="border border-black px-4 py-2">{{ $minScore }}</td>
        <th class="border border-black px-4 py-2">{{ $maxScore }}</td>
        <th class="border border-black px-4 py-2">{{ $averageScore }}</td>
        <th class="border border-black px-4 py-2">{{ $totalScores }}</td>
        <th class="border border-black px-4 py-2">{{ $standardDeviation }}</td>
    </tr>
